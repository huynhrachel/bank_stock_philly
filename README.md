...
Combines the three banks into one DataFrame

Cleans the column names to make the data easier to work with

Calculates daily returns for each bank
...
Builds a correlation matrix and visualizes it with a heatmap + clustermap

Uses Plotly + Cufflinks to make interactive charts

Adds simple technical analysis:
...
Open the notebook with Jupyter Notebook or VSCode.
